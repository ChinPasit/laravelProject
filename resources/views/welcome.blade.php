				...
				<span class="icon-bar"></span>
                    ...
                    <div id="navbar" class="collapse navbar-collapse navbar-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="about.html">เอกสารและแบบฟอร์ม</a></li>
                            <li><a href="contact.html">ติดต่อเรา</a></li>
                            <li><a  href="{{ route('Userlogin') }}">เข้าสู่ระบบ</a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 copyright">
                    Developed by <a href="#">THAKHAM Webapplication Office</a> designed by <a href="#">Designing Team</a>
                </div>
            </div>
        </div>
    </section>
